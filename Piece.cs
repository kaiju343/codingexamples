...
public class Piece : MonoBehaviour
{
    ...
    void OnMouseOver()
    {
		if (Input.GetMouseButtonDown(0) && ((_player == playerColor.WHITE)==manager.whiteTurn||(_player == playerColor.BLACK)==!manager.whiteTurn) && manager.playerTurn)
        {
            moves.Clear();
    ...
    void Update()
    {
        transform.position = Vector3.Lerp(this.transform.position, moveTo, 5 * Time.deltaTime);
    }
}
